...
row, runs one autoencoder, and calculates its reconstruction score and whether that
score is above the threshold. Only model execution and row scaling are shared libraries; the scoring
