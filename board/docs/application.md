...
- [`model_reconstruction_error_from_flash`](../application/model_reconstruction_error_from_flash/usermain.c): Scales Flash rows, runs the fixed st-ai autoencoder, and reports every row's reconstruction, reconstruction error and inference cycles.
