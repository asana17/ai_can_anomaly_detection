...
- [`score_and_detect_from_flash`](../application/score_and_detect_from_flash/README.md): Sends the Flash rows above `MIN_SPEED` through a queue, scores each with the rules and the autoencoder, and reports the rows an alarm starts and ends on.
