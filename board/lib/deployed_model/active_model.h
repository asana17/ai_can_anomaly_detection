...
#define STAI_ACTIVE_MODEL_ACTIVATIONS_SIZE              (580)
#define STAI_ACTIVE_MODEL_ACTIVATIONS_SIZE_BYTES        (580)
...
#define STAI_ACTIVE_MODEL_ACTIVATION_1_SIZE       (580)
#define STAI_ACTIVE_MODEL_ACTIVATION_1_SIZE_BYTES (580)
